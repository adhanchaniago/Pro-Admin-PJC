        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="col-sm-12 invoice-col">
                            <table border="0" style="font-family: Times New Roman">
                                <tr>
                                    <td>Sub SPB No </td>
                                    <td>:</td>
                                    <td>&emsp;<?php echo $dataDetailParty->pupuk_detail_nospb  ?></td>
                                </tr>
                                <tr>
                                    <td>Kepada Yth</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        &emsp;<?php echo $dataDetailParty->pupuk_detail_sppb  ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>&emsp;</td>
                                ...
                                <table>
                                    <tr>
                                        <td>&emsp;&emsp;&emsp;&emsp;Mohon Dimuatkan Pupuk berdasarkan rincian berikut</td>
                                        <td>:</td>
                                    </tr>
                                </table>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Jenis Pupuk</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataParty->pupuk_jenis ?></td>
                                </tr>
                                <tr>
                                    <td>Nama PT / CV</td>
                                    <td>&emsp;:</td>
                                ...
                                <tr>
                                    <td>Party SPK / STO</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataParty->pupuk_spk ?></td>
                                </tr>
                                <tr>
                                    <td>No. PO</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataParty->pupuk_po ?></td>
                                </tr>
                                <tr>
                                    <td>No Polisi</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataDetailParty->pupuk_detail_no_polisi  ?> </td>
                                </tr>
                                <tr>
                                    <td>Tonase</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataParty->pupuk_kontrak ?></td>
                                </tr>
                                <tr>
                                    <td>Nama Supir</td>
                                    <td>&emsp;:</td>
                                    <td>&emsp;<?php echo $dataDetailParty->pupuk_detail_nama_supir  ?> </td>
                                </tr>
                            </table>
                ...
                <div class="row no-print">
                    <div class="col-12">
                        <a href="module/pupuk/cetakrekap.php?id=<?php echo $id ?>" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> Print</a>
                    </div>
                </div>
                <br>
            </div>
