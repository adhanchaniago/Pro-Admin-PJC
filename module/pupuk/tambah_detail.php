<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Transporter</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="idPupuk" value="<?php echo $_GET['id'] ?>" type="hidden" class="form-control">
                                        <input name="noPolisi" type="text" class="form-control" placeholder="No. Polisi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">No. SPB</label>
                                    <div class="col-sm-8">
                                        <input name="noSpb" type="text" class="form-control" placeholder="No. SPB">
                                    </div>
                                </div>
                                <div class="form-group row">
