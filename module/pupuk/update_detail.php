        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            if ($db->saveDetailPupuk($_POST) > 0) {
                echo "
                    ...
                    window.location='index.php?page=module/pupuk/detail&id=$_GET[idPupuk]';
                    </script>
                    ";
            } else {
                echo "
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="idPupuk" value="<?php echo $_GET['idPupuk'] ?>" type="hidden" class="form-control">
                                        <input value="<?php echo $detailPupuk->pupuk_detail_id ?>" name="idDetail" type="hidden" readonly class="form-control" placeholder="">
                                        <input value="<?php echo $detailPupuk->pupuk_detail_no_polisi ?>" name="noPolisi" type="text" readonly class="form-control" placeholder="No. Polisi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input readonly name="noDo" value="<?php echo $detailPupuk->pupuk_detail_do ?>" type="text" class="form-control" placeholder="No. DO">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">No. Kontrak</label>
                                    <div class="col-sm-8">
                                        <input readonly value="<?php echo $detailPupuk->pupuk_detail_kontrak ?>" name="nokontrak" type="text" class="form-control" placeholder="No. Kontrak">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="jenisSatuan" id="JenisSatuan" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?php echo $data->satuan_id ?>"><?php echo $data->satuan_nama ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="nettoMuat" id="satuan" type="number" class="form-control" placeholder="Netto Muat">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input readonly value="<?php echo $detailPupuk->pupuk_detail_nama_supir ?>" name="namaSupir" type="text" class="form-control" placeholder="Nama Supir">
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    function prosesTotal() {
        ...
        var hasil = tagihan - admin - driver;
