        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            if ($db->saveDetailParty($_POST) > 0) {
                echo "
                    ...
                    window.location='index.php?page=module/party/detail&id=$_GET[idParty]';
                    </script>
                    ";
            } else {
                echo "
        ...
        <div class="row col-md-12">
            <div class="card card-info" style="width: 100%">
                ...
                <form method="POST" class="form-horizontal">
                    <?php
                    $detailParty = $db->getOneDetailParty($_GET['id']);
                    // var_dump($detailParty);
                    ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="idParty" value="<?php echo $_GET['idParty'] ?>" type="hidden" class="form-control">
                                        <input value="<?php echo $detailParty->party_detail_id ?>" name="idDetail" type="hidden" readonly class="form-control" placeholder="">
                                        <input value="<?php echo $detailParty->party_detail_no_polisi ?>" name="noPolisi" type="text" readonly class="form-control" placeholder="No. Polisi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input readonly name="noDo" value="<?php echo $detailParty->party_detail_do ?>" type="text" class="form-control" placeholder="No. DO">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">No. Kontrak</label>
                                    <div class="col-sm-8">
                                        <input readonly value="<?php echo $detailParty->party_detail_kontrak ?>" name="nokontrak" type="text" class="form-control" placeholder="No. Kontrak">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <script>
                                    function prosesSelisih() {
                                        ...
                                        document.getElementById('selisih').value = Math.abs(selisih);
                                    }
                                </script>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input readonly value="<?php echo $detailParty->party_detail_nama_supir ?>" name="namaSupir" type="text" class="form-control" placeholder="Nama Supir">
                                    </div>
                                </div>
                                <div class="form-group row">
